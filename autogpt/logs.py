...
def print_assistant_thoughts(
    ...
    logger.typewriter_log("REASONING:", Fore.YELLOW, f"{translator.translate(assistant_thoughts_reasoning, dest='zh-CN').text}")
    if assistant_thoughts_plan:
        logger.typewriter_log("PLAN:", Fore.YELLOW, "")
        # If it's a list, join it into a string
        if isinstance(assistant_thoughts_plan, list):
    ...
    logger.typewriter_log("CRITICISM:", Fore.YELLOW, f"{translator.translate(assistant_thoughts_criticism, dest='zh-CN').text}")
    # Speak the assistant's thoughts
    if CFG.speak_mode and assistant_thoughts_speak:
        say_text(assistant_thoughts_speak)
